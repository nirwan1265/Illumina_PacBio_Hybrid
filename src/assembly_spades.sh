...
./spades.py --isolate -t 10 \
-1 "${illumina_dir}/illumina_simulated_l50_c10_${filename}_pe1.fq" \
-2 "${illumina_dir}/illumina_simulated_l50_c10_${filename}_pe2.fq" \
--pacbio "${pacbio_dir}/simulated_pacbio_c5_l500_${filename}__0001.fastq" \
